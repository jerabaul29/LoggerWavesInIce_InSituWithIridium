...
number_of_points_to_use = global_fs * 60 * 20  # 20 minutes
first_IMU_point_to_use = global_fs * 1
last_IMU_point_to_use = first_IMU_point_to_use + number_of_points_to_use
...
class WaveStatistics(object):
    ...
    def __init__(self, path_in, filename, verbose, fs=global_fs, debug=global_debug):
    ...
    def compute_vertical_elevation(self):
        ...
        # filter
        self.pos_z_filtered = bandpass_instance.filter_data(pos_z, dx=1.0 / self.fs)
    ...
    def find_valid_index_PSD_WS(self):
        ...
        for current_index in self.f_PSD_WS.shape[0]:
    ...
    def compute_wave_spectrum_moments(self):
        ...
        self.M0 = integrate.cumtrapz(self.S_PSD_WS[self.index_min_PSD_WS: self.index_max_PSD_WS], omega[self.index_min_PSD_WS: self.index_max_PSD_WS])
        self.M1 = integrate.cumtrapz(self.S_PSD_WS[self.index_min_PSD_WS: self.index_max_PSD_WS] * (omega[self.index_min_PSD_WS: self.index_max_PSD_WS]), omega[self.index_min_PSD_WS: self.index_max_PSD_WS])
        self.M2 = integrate.cumtrapz(self.S_PSD_WS[self.index_min_PSD_WS: self.index_max_PSD_WS] * (omega[self.index_min_PSD_WS: self.index_max_PSD_WS]**2), omega[self.index_min_PSD_WS: self.index_max_PSD_WS])
        self.M3 = integrate.cumtrapz(self.S_PSD_WS[self.index_min_PSD_WS: self.index_max_PSD_WS] * (omega[self.index_min_PSD_WS: self.index_max_PSD_WS]**3), omega[self.index_min_PSD_WS: self.index_max_PSD_WS])
        self.M4 = integrate.cumtrapz(self.S_PSD_WS[self.index_min_PSD_WS: self.index_max_PSD_WS] * (omega[self.index_min_PSD_WS: self.index_max_PSD_WS]**4), omega[self.index_min_PSD_WS: self.index_max_PSD_WS])

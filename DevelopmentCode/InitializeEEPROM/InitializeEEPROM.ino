...
void setup(){
  ...
  EEPROMWritelong(address_numberReset, 201);
  EEPROM.write(address_sleeps_left, 1);
  EEPROM.write(address_total_sleeps, 9); // number of times sleeps before waking up; 1 sleep is around 20 minutes with the default real world data.
  // EEPROM.write(address_total_sleeps, 4); // number of times sleeps before waking up; 1 sleep is around 20 minutes with the default real world data.
